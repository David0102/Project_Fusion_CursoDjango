    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('lni-rocket', 'Foguete'), ('lni-users', 'Usuários'), ('lni-cog', 'Engrenagem'), ('lni-statis-up', 'Gráfico'), ('lni-mobile', 'Mobile'), ('lni-layers', 'Designer')], max_length=13, verbose_name='Icone')),
            ],
            options={
